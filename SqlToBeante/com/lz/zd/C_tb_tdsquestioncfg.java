package com.lz.zd;
	...
	/**
	**备注(数据表的comment字段)：问卷问题配置表
	*@since 2016-03-03 15:14:02
	*/

	public class C_tb_tdsquestioncfg{
@FieldDesc("主键ID")
	private String ID;
@FieldDesc("问题")
	private String CURRENTNEEDSQUESTION;
@FieldDesc("备注")
...
@FieldDesc("注销原因")
	...
	public String getCURRENTNEEDSQUESTION(){
		return this.CURRENTNEEDSQUESTION;
	}
	public void setCURRENTNEEDSQUESTION(String CURRENTNEEDSQUESTION){
		this.CURRENTNEEDSQUESTION=CURRENTNEEDSQUESTION;
	}

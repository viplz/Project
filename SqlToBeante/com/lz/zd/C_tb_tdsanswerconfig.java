package com.lz.zd;
	...
	/**
	**备注(数据表的comment字段)：问卷答案配置表
	*@since 2016-03-03 15:14:02
	*/

	public class C_tb_tdsanswerconfig{
@FieldDesc("主键ID")
	private String ID;
@FieldDesc("问题配置表ID")
	private String TDSA_ID;
@FieldDesc("答案内容")
	private String CURRENTNEEDSANSWER;
@FieldDesc("备注")
...
@FieldDesc("null")
	...
	public String getTDSA_ID(){
		return this.TDSA_ID;
	}
	public void setTDSA_ID(String TDSA_ID){
		this.TDSA_ID=TDSA_ID;
	}
	public String getCURRENTNEEDSANSWER(){
		return this.CURRENTNEEDSANSWER;
	}
	public void setCURRENTNEEDSANSWER(String CURRENTNEEDSANSWER){
		this.CURRENTNEEDSANSWER=CURRENTNEEDSANSWER;
	}
